        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="mailto:dawoodtrader@gmail.com"
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              {['DC Breakers', 'AC Breakers', 'Changeover Switches', 'Relay Protection', 'Distribution Boxes', 'Electronics'].map((item) => (
                <li key={item} className="hover:text-emerald-400 transition-colors font-medium">{item}</li>
              ))}
            </ul>
          </div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li className="flex items-start gap-3 group">
                ...
                <div>
                  ...
                  <p className="text-sm">+92 3061339140</p>
                </div>
              </li>
              <li className="flex items-start gap-3 group">
                <div className="w-10 h-10 bg-emerald-500/20 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-emerald-500/30 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm">dawoodtrader@gmail.com</p>
                </div>
              </li>
              <li className="flex items-start gap-3 group">
                <div className="w-10 h-10 bg-emerald-500/20 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-emerald-500/30 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm">Rahim Yar Khan, 64200, Pakistan</p>
                </div>
              </li>
            </ul>
          </div>
