...
export function App() {
  ...
  const handleViewProduct = (category: ProductCategory, productId: string) => {
    setPageState({
      page: 'product',
  ...
  const renderPage = () => {
    switch (pageState.page) {
      ...
      case 'products':
        return <ProductsPage onNavigate={handleNavigate} onViewProduct={handleViewProduct} />;
      case 'category':
        return (
          <CategoryPage
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {showHeader && <Header onNavigate={handleNavigate} currentPage={pageState.page} />}
